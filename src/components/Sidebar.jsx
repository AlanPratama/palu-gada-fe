          ...
          <div className={`flex flex-col gap-6 px-4`}>
            ...
            <div className='flex gap-2 flex-col'>
              ...
              <Button
                ...
                color={location.pathname == "/agreement" ? "primary" : "default"}
                className=' active:bg-none max-w-full justify-start'
              ...
              <Button
                ...
                color={location.pathname == "/report-post" ? "primary" : "default"}
                className=' active:bg-none max-w-full justify-start'
            ...
            <div className='flex gap-2 flex-col'>
              ...
              <Button
                ...
                color={location.pathname == "/error-report" ? "primary" : "default"}
                className=' active:bg-none max-w-full justify-start'
