  ...
  return (
    <div className="bg-white dark:bg-gray-800 flex flex-1 min-h-screen">
      <div className="my-auto px-4 py-16 mx-auto w-3/4 md:px-24 lg:px-4 lg:py-10">
        <div className="flex flex-col overflow-hidden bg-white dark:bg-gray-800 rounded-xl shadow-md lg:flex-row sm:mx-auto">
          <div className="relative lg:w-1/2 bg-gradient-to-br from-[#4f6def] to-purple-500">
            ...
            />
            <svg
              className="absolute top-0 -right-2 hidden h-full dark:text-gray-900 text-white lg:inline-block"
              viewBox="0 0 20 104"
              fill="currentColor"
            >
