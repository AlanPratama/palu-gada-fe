  ...
  return (
    <div className='bg-white flex flex-1 min-h-screen'>
      <div className='my-auto px-4 mx-auto sm:w-3/4 md:px-24 lg:px-4 max-lg:py-4 py-2'>
        <div className='flex flex-col overflow-hidden bg-white border rounded-xl shadow-md lg:flex-row-reverse sm:mx-auto'>
          <div className='relative lg:w-1/2 bg-gradient-to-br from-primary to-purple-500'>
            <svg
              className='absolute top-0 -left-1 hidden -scale-100 h-full text-white lg:inline-block'
              viewBox='0 0 20 104'
              fill='currentColor'
            >
