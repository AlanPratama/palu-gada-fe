...
export default function RegisterCard() {
  ...
  return (
    <div className='w-full max-w-md lg:pl-8 pl-0 mx-auto'>
      <h1 className='text-red-500 font-bold top-0 right-0 mb-8 animate__animated animate__fadeInDown'>Kerjain Aja Admin</h1>
      <div className='space-y-1 flex flex-col mb-4 animate__animated animate__fadeInDown'>
        ...
        <p className='font-light text-gray-500 text-sm'>Lengkapi form untuk membuat akun baru.</p>
      </div>
      <div>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              {errors.secretKey && <p className='text-red-500 text-xs mt-2'>{errors.secretKey.message}</p>}
            </div>
          </div>
          <Button className='w-full my-6 bg-primary text-white' type='submit' isLoading={isLoading}>
